...
| [Ultralytics YOLO](https://www.stepsecurity.io/blog/ultralytics-workflow-compromise) | Dec 2024 | Branch name injection via `${{ github.head_ref }}` | `pull_request_target`, Expression Injection |
